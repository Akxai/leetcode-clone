...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({
  ...
  const handleLike = async () => {
    if (!user) {
      return toast.error("Please login to like the problem ⚠️", {
        position: "top-center",
        autoClose: 2000,
        theme: "dark",
      });
  ...
  const handleDislike = async () => {
    if (!user) {
      toast.error("Please login to dislike the problem ⚠️", {
        position: "top-center",
        theme: "dark",
      });
      return;
  ...
  const handleStar = async () => {
    if (!user) {
      return toast.error("Please login to star the problem ⚠️", {
        position: "top-center",
        autoClose: 2000,
        theme: "dark",
      });
