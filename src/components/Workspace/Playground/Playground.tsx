...
const Playground: React.FC<PlaygroundProps> = ({
  ...
  // useLocalStorage("editorFontSize", settings.fontSize);
  ...
  const handleSubmit = async () => {
    if (!user) {
      toast.error("Please login to submit your solution ⚠️", {
        position: "top-center",
        autoClose: 2000,
        theme: "dark",
      });
    ...
    try {
      ...
      if (
        ...
        toast.error("oops! One or more test cases failed ⚠️", {
          position: "top-center",
          autoClose: 2000,
          theme: "dark",
        });
        ...
        toast.error("Please use ES6 syntax ⚠️", {
          position: "top-center",
          autoClose: 2000,
          theme: "dark",
        });
